...
public class NewActivity {
    ...
    public static class Task1 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            URL url = null;
            try {
                url = new URL("https://testapi.openbanking.or.kr/v2.0/account/transaction_list/fin_num?bank_tran_id=T991663280U" + numStr + "&fintech_use_num=199166328057887392605371&inquiry_type=A&inquiry_base=D&from_date=" + start + "&to_date=" + end + "&sort_order=D&tran_dtime=20201006025351");
        ...
        public String listjsonParser(String jsonString) {
            ...
            try {
                ...
                for (int i = 0; i < jarray.length(); i++) {
                    ...
                    a[i] = tran_date;
                    if(Integer.parseInt(start)<=Integer.parseInt(a[i])&&Integer.parseInt(end)>=Integer.parseInt(a[i])){
                        result += a[i] + "\n";}
    ...
    public static class Task4 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            URL url = null;
            try {
                url = new URL("https://testapi.openbanking.or.kr/v2.0/account/transaction_list/fin_num?bank_tran_id=T991663280U"
                        +numStr+"&fintech_use_num=199166328057887392605371&inquiry_type=A&inquiry_base=D&from_date="+start+"&to_date="
                        +end+"&sort_order=D&tran_dtime=20201006025351");
    ...
    public static class Food extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                url = new URL("https://testapi.openbanking.or.kr/v2.0/account/transaction_list/fin_num?bank_tran_id=T991663280U"
                        + numStr + "&fintech_use_num=199166328057887392605371&inquiry_type=A&inquiry_base=D&from_date=" + start +
                        "&to_date=" + end + "&sort_order=D&tran_dtime=20201006025351");
    ...
    public static class Life extends AsyncTask<String, Void, String> {
        private String str, receiveMsg;
        String start = ((SubActivity) SubActivity.context).s_start;
        String end = ((SubActivity) SubActivity.context).s_end;
    ...
    public static class Culture extends AsyncTask<String, Void, String> {
        private String str, receiveMsg;
        String start = ((SubActivity) SubActivity.context).s_start;
        String end = ((SubActivity) SubActivity.context).s_end;
